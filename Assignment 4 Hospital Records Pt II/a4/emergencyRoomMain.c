...
int main(int argc, char* argv[])
{
	...
	printf("Storing all data in ASCII file:\n");
	rc = createAsciiBackup("ASCII.txt", patientsList);

	printf("Storing all data in BINARY file:\n");
	rc = createBinaryBackup("BINARY.bin", patientsList);
